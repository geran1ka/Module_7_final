...
import {getCheckItemCart} from '../../helper/getCheckItemCart.js';
import {loanCalculation} from '../../helper/loanСalculation.js';
import {addCart, removeCart} from '../cart/cartController.js';
import {addFavorite, getFavorite, removeFavorite} from '../favorite/favoriteController.js';

export const createCard = (preload, data) => createElement('section', {
  className: 'card',
}, {
