...
;// CONCATENATED MODULE: ./src/js/modules/favoriteController.js
...
const cardPageInit = async id => {
  main.textContent = '';
  const cardItem = await getGoodsId(createCard, id);
  main?.prepend(cardItem);
};
;// CONCATENATED MODULE: ./src/js/modules/category/renderMenuCatalog.js
...
let render = true;
const renderMenuCatalogHeader = array => {
  if (render) {
...
;// CONCATENATED MODULE: ./src/js/modules/categoryController.js
...
const searchController = () => {
  ...
  searchForm.addEventListener('input', e => {
    ...
    delay = setTimeout(async () => {
      ...
      productSearch ? main?.append(productSearch) : main?.append(createElement('section', {
        className: 'search'
      }, {
        append: createElement('div', {
