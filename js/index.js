...
;// CONCATENATED MODULE: ./src/js/helper/const.js
...
;// CONCATENATED MODULE: ./src/js/helper/createElement.js
...
;// CONCATENATED MODULE: ./src/js/helper/createError.js

const createError = err => createElement('div', {
...
;// CONCATENATED MODULE: ./src/js/helper/fetchRequest.js
...
;// CONCATENATED MODULE: ./src/js/helper/getTotalCountProduct.js
const getTotalCountProduct = arr => arr.reduce((acc, item) => acc + +item.count, 0);
;// CONCATENATED MODULE: ./src/js/helper/addMainContent.js

const addMainContent = (content, prepend = false) => {
  main.textContent = '';
  return prepend ? main.prepend(content) : main.append(content);
};
;// CONCATENATED MODULE: ./src/js/modules/serviceAPI.js


const getCategory = callback => fetchRequest(`${URL}/api/category`, {
  method: 'get',
  callback
});
const getGoodsCategory = (callback, category) => fetchRequest(`${URL}/api/goods/category/${category}`, {
  method: 'get',
  callback
});
const getGoodsId = (callback, id) => fetchRequest(`${URL}/api/goods/${id}`, {
  method: 'get',
  callback
});
...
const getDataSearch = (callback, search = '') => fetchRequest(`${URL}/api/goods?search=${search}`, {
  method: 'get',
  callback
});
const getDataBlog = (callback, search = '') => fetchRequest(`${API_URL_POST}?${search}}`, {
  method: 'get',
  callback
});
const getDataArticle = (callback, id = '') => fetchRequest(`${API_URL_POST}/${id}}`, {
  method: 'get',
  callback
});
const getAuthorArticle = (callback, id = '') => fetchRequest(`${API_URL_USERS}/${id}}`, {
  method: 'get',
  callback
});
;// CONCATENATED MODULE: ./src/js/modules/article/createAside.js

const createAside = () => createElement('aside', {
  className: 'aside'
}, {
  append: createElement('div', {
...
;// CONCATENATED MODULE: ./src/js/modules/article/createAticle.js
...
;// CONCATENATED MODULE: ./src/js/modules/bread/getArrHashString.js
...
;// CONCATENATED MODULE: ./src/js/modules/article/renderArticle.js
...
const renderArticle = async (err, data) => {
  if (err) {
    console.warn(err);
...
;// CONCATENATED MODULE: ./src/js/modules/article/articleInit.js



const articleInit = async currentLocation => {
  const idU = currentLocation?.hashString.split('/')[1];
  addMainContent(await getDataArticle(renderArticle, idU));
};
;// CONCATENATED MODULE: ./src/js/helper/overlayLoadImg.js

const overlayImgLoad = () => createElement('div', {
  className: 'overlay-load',
  innerHTML: `
...
;// CONCATENATED MODULE: ./src/js/modules/blog/createBlog.js
...
;// CONCATENATED MODULE: ./src/js/modules/blog/createBlogItem.js

const createBlogItem = (item, preload) => {
  const li = createElement('li', {
    ...
    append: createElement('article', {
      ...
      appends: [createElement('div', {
        ...
        appends: [preload, createElement('img', {
...
;// CONCATENATED MODULE: ./src/js/modules/blog/paginationControl.js
...
;// CONCATENATED MODULE: ./src/js/modules/blog/renderPagination.js
...
;// CONCATENATED MODULE: ./src/js/modules/blog/renderBlog.js
...
;// CONCATENATED MODULE: ./src/js/modules/blog/blogInit.js



const blogInit = async currentLocation => {
  // const currentLocation = router.getCurrentLocation();
  const search = currentLocation?.queryString || '';
  addMainContent(await getDataBlog(renderBlog, search));
};
;// CONCATENATED MODULE: ./src/js/modules/bread/breadInit.js
...
;// CONCATENATED MODULE: ./src/js/helper/dateDelivery.js
...
;// CONCATENATED MODULE: ./src/js/modules/cart/cartController.js
...
;// CONCATENATED MODULE: ./src/js/helper/getCheckItemCart.js

const getCheckItemCart = id => {
  const listCart = getCart();
  return listCart.some(item => item.id === id);
};
;// CONCATENATED MODULE: ./src/js/helper/loanСalculation.js
const loanCalculation = sum => {
  const interestRate = 15;
  const creditTerm = 18;
  const monthlyInterestRate = interestRate / 12 / 100;
  const annuityRatio = monthlyInterestRate * (1 + monthlyInterestRate) ** creditTerm / ((1 + monthlyInterestRate) ** creditTerm - 1);
  return Math.round(sum * annuityRatio);
};
;// CONCATENATED MODULE: ./src/js/modules/favorite/favoriteController.js
...
const createCard = (preload, data) => createElement('section', {
  className: 'card'
}, {
  append: createElement('div', {
    ...
    appends: [createElement('h2', {
      ...
      appends: [createElement('div', {
        ...
        appends: [createElement('p', {
          ...
          appends: [createElement('span', {
            className: data.discount ? 'card__price-new' : 'card__price-new card__price-new_black',
            textContent: data.discount ? `${Math.round(data.price - data.price * data.discount / 100)} ₽` : `${data.price} ₽`
          }), createElement('span', {
        ...
        appends: [createElement('button', {
          ...
          className: `card__btn-favorite 
                    ${getFavorite().find(item => item.id === data.id) ? 'card__btn-favorite_active' : ''}`,
...
;// CONCATENATED MODULE: ./src/js/modules/cardPage/renderCard.js
...
;// CONCATENATED MODULE: ./src/js/modules/cardPage/cardPageInit.js



const cardPageInit = async id => addMainContent(await getGoodsId(renderCard, id), true);
;// CONCATENATED MODULE: ./src/js/modules/cart/itemCart.js
...
const itemCart = cartArray => cartArray.map(item => {
  ...
  const getPrice = (item, discount = true) => item.discount ? (item.price - item.price * item.discount * discount / 100) * item.count : item.price * item.count;
  ...
  return createElement('li', {
    ...
    appends: [checkDelItem, createElement('img', {
      ...
      appends: [createElement('div', {
        ...
        appends: [btnMinusCount, countItemCart, btnPlusCount, createElement('input', {
        ...
        appends: [price, priceOld, priceCredit]
      }), btnDelItem]
    })]
  });
});
;// CONCATENATED MODULE: ./src/js/modules/cart/createCart.js




const createCart = cartArray => {
...
;// CONCATENATED MODULE: ./src/js/modules/cart/createDelivery.js



const createDelivery = cartArray => {
...
;// CONCATENATED MODULE: ./src/js/helper/getTotalPrice.js
const getTotalPrice = (arr, discountFlag = true) => Math.round(arr.reduce((acc, item) => item.discount ? acc + (item.price - item.price * item?.discount * discountFlag / 100) * item.count : acc + item.price * item.count, 0));
;// CONCATENATED MODULE: ./src/js/modules/cart/createInfo.js




const createInfo = cartArray => {
...
;// CONCATENATED MODULE: ./src/js/helper/getEmptyData.js

const getEmptyData = (className, text) => createElement('section', {
  className
}, {
  append: createElement('div', {
...
;// CONCATENATED MODULE: ./src/js/modules/cart/renderCart.js
...
const renderCart = cartArray => {
  ...
  return createElement('section', {
    ...
    append: createElement('div', {
      ...
      appends: [cart, delivery, info]
    })
  });
};
;// CONCATENATED MODULE: ./src/js/modules/cart/cartInit.js



const cartInit = () => addMainContent(renderCart(getCart()));
;// CONCATENATED MODULE: ./src/js/modules/catalog/createCatalog.js

const createCatalog = list => createElement('section', {
  className: 'catalog'
}, {
  append: createElement('div', {
...
;// CONCATENATED MODULE: ./src/js/modules/catalog/createCatalogItem.js

const createCatalogItem = title => createElement('li', {
...
;// CONCATENATED MODULE: ./src/js/modules/catalog/renderCatalog.js
...
;// CONCATENATED MODULE: ./src/js/modules/catalog/catalogInit.js



const catalogInit = async () => addMainContent(await getCategory(renderCatalog));
;// CONCATENATED MODULE: ./src/js/modules/category/createItemCatalogMenu.js

const createItemCatalogMenu = title => createElement('li', {
...
;// CONCATENATED MODULE: ./src/js/modules/category/menuCatalogInit.js
    ...
    append: createElement('article', {
      ...
      appends: [createElement('h3', {
        ...
        appends: [createElement('p', {
          ...
          textContent: item.discount ? `${Math.round(item.price - item.price * item.discount / 100)} ₽` : `${item.price} ₽`
        }), createElement('p', {
...
;// CONCATENATED MODULE: ./src/js/modules/product/renderProductList.js


const renderProductList = (err, array) => {
  if (err) {
    console.warn(err);
    createError(err);
    return;
...
;// CONCATENATED MODULE: ./src/js/modules/favorite/favoriteinit.js





const favoriteInit = async () => {
...
;// CONCATENATED MODULE: ./src/js/modules/goods/goodsInit.js




const goodsInit = async ([, category, id]) => {
...
;// CONCATENATED MODULE: ./src/js/modules/mainPage/createHero.js

const createHero = timer => createElement('section', {
  className: 'hero'
}, {
  append: createElement('div', {
...
;// CONCATENATED MODULE: ./src/js/modules/mainPage/createPromoCards.js

const crteatePromoCards = () => createElement('section', {
...
;// CONCATENATED MODULE: ./src/js/modules/product/renderDiscountListNew.js


const renderDiscountList = (err, array) => {
  if (err) {
    console.warn(err);
    createError(err);
    return;
...
;// CONCATENATED MODULE: ./src/js/modules/mainPage/goodsDiscountInit.js
...
;// CONCATENATED MODULE: ./src/js/modules/mainPage/createTimer.js
...
;// CONCATENATED MODULE: ./src/js/modules/timer/timerRender.js
...
;// CONCATENATED MODULE: ./src/js/modules/timer/decl0fNum.js
...
;// CONCATENATED MODULE: ./src/js/modules/timer/getTwoDigits.js
const getTwoDigits_getTwoDigits = num => ('0' + num).slice(-2);
;// CONCATENATED MODULE: ./src/js/modules/timer/timerControl.js
...
const timerControl = (timer, deadline) => {
  ...
  const start = () => {
    ...
    if (time.timeRemaining < 0) {
      ...
      timerElem.timerCountDays.textContent = getTwoDigits_getTwoDigits(hours.n);
      timerElem.timerUnitsDays.textContent = hours.title;
      timerElem.timerCountHours.textContent = getTwoDigits_getTwoDigits(minutes.n);
      timerElem.timerUnitsHours.textContent = minutes.title;
      timerElem.timerCountMinutes.textContent = getTwoDigits_getTwoDigits(seconds.n);
      ...
      timerElem.timerCountHours.textContent = getTwoDigits_getTwoDigits(hours.n);
      timerElem.timerUnitsHours.textContent = hours.title;
      timerElem.timerCountMinutes.textContent = getTwoDigits_getTwoDigits(minutes.n);
      timerElem.timerUnitsMinutes.textContent = minutes.title;
    }
  };
  return start();
};
;// CONCATENATED MODULE: ./src/js/modules/timer/timerInit.js
...
;// CONCATENATED MODULE: ./src/js/modules/mainPage/mainPageInit.js
...
;// CONCATENATED MODULE: ./src/js/helper/scrollControl.js
...
;// CONCATENATED MODULE: ./src/js/modules/menu&accControl.js
...
const menuControll = () => {
  jquery('body').on('click', e => {
    ...
    } else if (e.target.closest('.menu__catalog-link') || e.target.closest('.menu__info-link') || e.target.closest('.menu__contacts-link') || e.target.closest('.menu__catalog-title')) {
      closeMenuA();
    }
  });
};
...
const profileController = () => addMainContent(getEmptyData('profile', 'Данная страница находится в разработке'));
;// CONCATENATED MODULE: ./src/js/modules/searchController.js
...
const searchController = () => {
  ...
  searchForm.addEventListener('input', e => {
    ...
    delay = setTimeout(async () => {
      ...
      productSearch ? addMainContent(productSearch) : addMainContent(getEmptyData('search', `По вашему запросу ${search.value} ничего ненайдено`));
...
;// CONCATENATED MODULE: ./src/js/modules/shop/createCategoryGoods.js

const createCategoryGoods = category => {
...
;// CONCATENATED MODULE: ./src/js/modules/shop/renderShop.js
...
const renderShop = category => {
  const {
    section,
    categoryGoodsList
  } = createCategoryGoods(category);
  getGoodsCategory(renderProductList, category).then(array => categoryGoodsList.append(...array));
  return section;
};
;// CONCATENATED MODULE: ./src/js/modules/shop/shopInit.js


const shopInit = category => addMainContent(renderShop(category), true);
...
const init = async () => {
  try {
    const data = await fetchRequest(`${URL}/api/category/`, {
      method: 'get'
    });
    let flag = true;
